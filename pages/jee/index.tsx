  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Our website is a one-stop destination for JEE aspirants looking for high-quality handwritten notes to boost their exam preparation. We offer an extensive collection of notes covering a wide range of topics, created by JEE aspirants.
